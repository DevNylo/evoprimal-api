...
export interface ApiHeroBannerHeroBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    destaque_verde: Schema.Attribute.String;
...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<
      ['whey-protein', 'creatina', 'pre-treino', 'vitaminas', 'beta-alanina']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descricao: Schema.Attribute.Text;
    em_destaque: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    imagem: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    preco_antigo: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    complement: Schema.Attribute.String & Schema.Attribute.Required;
